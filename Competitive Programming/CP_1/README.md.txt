What if you want to make playful problems to ease up minds?Sounds fun,right?
...
And now for this we need a code which can tranverse this matrix in a columnar way and also in a contiguous manner.

And hence we should have our output as
