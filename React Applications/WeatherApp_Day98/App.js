...
class App extends Component {
  ...
  getWeather = async e => {
    ...
    if (city && country) {
      ...
      // Incase it doesn't work then throw the error to catch block
      // try block is fetching data from the API from the already made website
      try {
        ...
        // Set states of properties to the current temperature.
        ...
        // Catch the error and print it on the console
      } catch (ex) {
